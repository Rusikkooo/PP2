...
# Upload resources 
image_background = pygame.image.load('lab9/Race car/resources/road_0.png')
image_background = pygame.transform.scale(image_background, (WIDTH, HEIGHT))

# coin
image_coin = pygame.image.load('lab9/Race car/resources/coin.png')
image_coin = pygame.transform.scale(image_coin, (30, 30))

# background music
pygame.mixer.music.load('lab9/Race car/resources/background.wav')
pygame.mixer.music.play(-1)
sound_crash = pygame.mixer.Sound('lab9/Race car/resources/car-crash_A_minor.wav')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab9/Race car/resources/Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab9/Race car/resources/Player.png')
