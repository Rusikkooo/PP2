...
# Upload resources 
image_background = pygame.image.load('lab8/Race car/recources/road_0.png')
image_background = pygame.transform.scale(image_background, (WIDTH, HEIGHT))

# coin
image_coin = pygame.image.load('lab8/Race car/recources/coin.png')
image_coin = pygame.transform.scale(image_coin, (30, 30))

# background music
pygame.mixer.music.load('lab8/Race car/recources/LAB8_Race car_resources_background.wav')
pygame.mixer.music.play(-1)
sound_crash = pygame.mixer.Sound('lab8/Race car/recources/LAB8_Race car_resources_car-crash_A_minor.wav')
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab8/Race car/recources/Enemy.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('lab8/Race car/recources/Player.png')
